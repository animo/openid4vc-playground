...
const _x509PidIssuerRootCertificate =
...
const _x509PidIssuerCertificate =
...
const _x509BdrMdlIssuerCertificate = `-----BEGIN CERTIFICATE-----
  ...
  modules: {
    ...
    x509: new X509Module({
      ...
      trustedCertificates: [
        ...
        // Sourced here: https://playground.france-identite.gouv.fr/doc/marketplace/wallets/fin/#iaca-certificate
        `-----BEGIN CERTIFICATE-----
