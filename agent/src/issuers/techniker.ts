...
export const healthIdMdocData = {
  credentialSupportedId: healthIdMdoc.id,
...
export const healthIdSdJwtData = {
  credentialSupportedId: healthIdSdJwt.id,
...
export const technikerIssuer = {
  ...
  credentialsSupported: [healthIdSdJwt, healthIdMdoc],
  display: [
    {
      name: 'Die Techniker',
      logo: {
...
export const technikerCredentialsData = {
  [healthIdSdJwtData.credentialSupportedId]: healthIdSdJwtData,
  [healthIdMdocData.credentialSupportedId]: healthIdMdocData,
}
